...
public static class TagNameCreator
{
    ...
    private const string PATH = "Assets/Scripts/Constants/TagName.cs";      // ファイルパス
    ...
    public static void CreateScript()
    {
        ...
        builder.AppendLine("/// </summary>");
        builder.AppendLine("namespace Constants").AppendLine("{");
        builder.Append("\t").AppendFormat("public static class {0}", FILENAME_WITHOUT_EXTENSION).AppendLine();
